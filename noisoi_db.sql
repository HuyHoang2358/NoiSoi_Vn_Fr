...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10000049 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table label_img_db.images: ~6 rows (approximately)
DELETE FROM `images`;
...
-- Dumping data for table label_img_db.migrations: ~9 rows (approximately)
...
-- Dumping data for table label_img_db.projects: ~0 rows (approximately)
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('hK5TptZQJou56Tx2rmiLEAu9PMf7rBlrWZsXmrdP', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36', '', 1705135731),
